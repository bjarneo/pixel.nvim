...
function M.setup(colors, config)
	...
	hi("MiniFilesNormal", { ctermfg = colors.white, ctermbg = colors.black })
	...
	-- Mini.map
	hi("MiniMapNormal", { ctermfg = colors.white, ctermbg = colors.black })
	...
	hi("MiniPickNormal", { ctermfg = colors.white, ctermbg = colors.black })
